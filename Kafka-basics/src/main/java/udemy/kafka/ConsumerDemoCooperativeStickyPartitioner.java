...
public class ConsumerDemoCooperativeStickyPartitioner {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConsumerDemoCooperativeStickyPartitioner.class);
